    ...
    return (
        <div className="min-h-screen bg-black flex flex-col items-center p-4 md:p-8">
            ...
            <div className="w-full max-w-[1400px] grid grid-cols-1 md:grid-cols-3 gap-4 mb-6 md:mb-8">
                {/* 1. Week Info */}
                <div className="pool-card p-6 bg-linear-to-br from-[#1A1A1A] to-black border-none relative overflow-hidden flex flex-col justify-center">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-pool-green/10 rounded-full blur-3xl -mr-10 -mt-10"></div>
                    <div className="relative z-10">
                        <p className="text-slate-400 text-xs font-bold uppercase mb-1">Jornada Actual</p>
                        <h2 className="text-2xl font-black text-white">{weekName}</h2>
                        <div className="w-12 h-1 bg-pool-green rounded-full mt-2"></div>
                    </div>
                </div>

                {/* 2. Prize Display */}
                <div className="pool-card p-4 md:p-6 bg-[#111] border-none flex flex-col items-center justify-center text-center relative overflow-hidden group">
                    <div className="absolute inset-0 bg-pool-green/5 group-hover:bg-pool-green/10 transition-colors"></div>
                    <p className="text-[10px] text-slate-500 font-bold uppercase mb-1 tracking-widest relative z-10">Premio a Repartir</p>
                    ...
                    <p className="text-[10px] text-slate-600 font-bold uppercase mt-2 relative z-10">
                        ({participants.length} Participantes)
                    </p>
                </div>

                {/* 3. Total Goals */}
                <div className="pool-card p-4 md:p-6 bg-[#111] border-none flex items-center justify-between relative overflow-hidden">
                    <div className="absolute -left-6 -bottom-6 w-24 h-24 bg-white/5 rounded-full blur-xl"></div>
                    <div className="relative z-10">
                        <p className="text-xs text-slate-500 font-bold uppercase mb-1">Total Goles (Real)</p>
